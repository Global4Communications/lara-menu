    ...
    public function run()
    {
        DB::table('core_menus')->insert([
            ...
            [
                ...
                'type' => 'link',
                'text' => 'Affinity',
                'route' => 'https://crm.global4.co.uk/affinity/tickets/teams/overview',
                'priority' => 1,
            ],
            [
                ...
                'route' => 'https://crm.global4.co.uk/affinity/overview/orders/hometelecom',
                'priority' => 2,
            ],
            [
                ...
                'route' => 'https://crm.global4.co.uk/affinity/global4-billing-management-report',
                'priority' => 3,
            ],
            [
                ...
                'route' => 'https://crm.global4.co.uk/affinity/hometelecom-billing-management-report',
                'priority' => 4,
            ],
            [
                ...
                'route' => 'https://crm.global4.co.uk/affinity/weeklybroadband-billing-management-report',
                'priority' => 5,
            ],
            [
                ...
                'route' => 'https://crm.global4.co.uk/access/statistics',
                'priority' => 6,
            ],
            [
                ...
                'type' => 'link',
                'text' => 'Accounts',
                'route' => 'https://crm.global4.co.uk/statistics/accounts',
                'priority' => 7,
            ],
        ]);
    }
